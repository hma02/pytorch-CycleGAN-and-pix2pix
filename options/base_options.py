...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--loadSize_w', type=int, default=224, help='scale images to this size')
        self.parser.add_argument('--loadSize_h', type=int, default=150, help='scale images to this size')
        ...
        self.parser.add_argument('--n_classes', default=None, help='how many classes to be translated among')
